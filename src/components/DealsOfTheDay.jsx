...
const DealsOfTheDay = () => {
  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 medical-bg-pattern relative">
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 sm:mb-8 gap-4">
          <div className="w-full md:w-auto">
            <div className="flex items-center gap-2 mb-2">
              <FaTag className="text-red-500 text-xl sm:text-2xl" />
          ...
          <div className="flex items-center gap-2 sm:gap-4 bg-white px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-lg shadow-md w-full md:w-auto justify-center md:justify-start">
            <FaClock className="text-red-500 text-lg sm:text-xl" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {deals.map((deal) => (
            <div
              key={deal.id}
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-red-100 group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 bg-red-500 text-white px-2 sm:px-3 md:px-4 py-1 rounded-bl-lg text-xs sm:text-sm font-bold">
                {deal.tag}
              </div>
              
              <div className="relative mb-3 sm:mb-4">
                <div className="w-full h-32 sm:h-36 md:h-40 bg-gradient-to-br from-red-50 to-orange-50 rounded-xl flex items-center justify-center text-4xl sm:text-5xl md:text-6xl">
                  {deal.image}
                </div>
                <div className="absolute -top-2 -right-2 bg-red-500 text-white text-sm sm:text-base md:text-lg font-bold px-2 sm:px-3 py-1 rounded-full">
                  {deal.discount} OFF
                </div>
              </div>
              
              <h3 className="font-bold text-gray-800 text-base sm:text-lg mb-2 sm:mb-3 group-hover:text-red-600 transition-colors">
                {deal.name}
              </h3>
              ...
              <button className="w-full bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white font-bold py-2 sm:py-3 px-3 sm:px-4 rounded-lg transition-all flex items-center justify-center gap-2 text-sm sm:text-base shadow-lg hover:shadow-xl">
                <FaShoppingCart />
                <span>Buy Now</span>
              </button>
            </div>
